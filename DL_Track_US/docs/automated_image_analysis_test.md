...
- Select <span style="color: #a34ba1;">**NO**</span> for the **Filter Fascicles** option.
...
- Compare the analysis results of thickness, fasc_length_filtered and pennation_filtered to the expected outputs shown below.
